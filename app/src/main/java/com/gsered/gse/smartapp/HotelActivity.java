...
public class HotelActivity extends AppCompatActivity {
    ...
    company_webview hotels,agoda,akbartravels,goibibo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://gsered.com/charity/logo/Hotels.png").placeholder(R.mipmap.ic_launcher).into(imageView1);
        ...
        bundle1.putString("url", "https://ad.admitad.com/g/q38i489917d76c048b769abd4df56e/?subid=hers&subid1=hers1");
        hotels = company_webview.newInstance();
        hotels.setArguments(bundle1);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if(count==1)
            ...
            Intent i = new Intent(HotelActivity.this, MainActivity.class);
            startActivity(i);
        }
        ...
        if ((keyCode == KeyEvent.KEYCODE_BACK) && this.hotels != null && this.hotels.cangoback()) {
            this.hotels.goBack();
            return true;
        }
