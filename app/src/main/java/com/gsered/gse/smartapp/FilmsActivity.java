...
public class FilmsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://www.gsered.com/charity/logo/Moviecard.png").placeholder(R.mipmap.ic_launcher).into(imageView1);

        View view2 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView2 = (ImageView) view2.findViewById(R.id.icon);
        Glide.with(this).load("https://www.gsered.com/charity/logo/Bookmyshow.png").placeholder(R.mipmap.ic_launcher).into(imageView2);

        View view3 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView3 = (ImageView) view3.findViewById(R.id.icon);
        Glide.with(this).load("http://gsered.com/charity/logo/Paytm.png").placeholder(R.mipmap.ic_launcher).into(imageView3);

        View view4 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView4 = (ImageView) view4.findViewById(R.id.icon);
        Glide.with(this).load("https://gsered.com/charity/logo/ticketnew.png").placeholder(R.mipmap.ic_launcher).into(imageView4);

        Bundle bundle1 = new Bundle();
        bundle1.putString("url", "https://ad.admitad.com/g/m7k9ubkqlpd76c048b766b3e8fe152/?subid=hers&subid1=hers1");
        bundle1.putString("admitadid", "20587");
        bundle1.putString("raise", "17$");
        bundle1.putString("name", "Moviecard");
        bundle1.putString("imgurl", "https://gsered.com/charity/logo/Moviecard.png");
        swiggy = company_webview.newInstance();
        swiggy.setArguments(bundle1);

        Bundle bundle2 = new Bundle();
        bundle2.putString("url", "https://in.bookmyshow.com/");
        ubereats = company_webview.newInstance();
        ubereats.setArguments(bundle2);

        Bundle bundle3 = new Bundle();
        bundle3.putString("url", "https://paytm.com/movies/");
        faasos = company_webview.newInstance();
        faasos.setArguments(bundle3);

        Bundle bundle4 = new Bundle();
        bundle4.putString("url", "https://www.ticketnew.com/");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if(count==1)
            ...
            Intent i = new Intent(FilmsActivity.this, MainActivity.class);
            startActivity(i);
        }
