...
public class HomeServicesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://gsered.com/charity/logo/Housejoy.jpg").placeholder(R.mipmap.ic_launcher).into(imageView1);

        View view2 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView2 = (ImageView) view2.findViewById(R.id.icon);
        Glide.with(this).load("http://gsered.com/charity/logo/UrbanClap.png").placeholder(R.mipmap.ic_launcher).into(imageView2);

        View view3 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView3 = (ImageView) view3.findViewById(R.id.icon);
        Glide.with(this).load("https://www.gsered.com/charity/logo/Heimdalsecurity.png").placeholder(R.mipmap.ic_launcher).into(imageView3);
...
//        Glide.with(this).load("https://gsered.com/charity/logo/Pizzahut.png").placeholder(R.mipmap.ic_launcher).into(imageView4);
        ...
        bundle1.putString("url", "https://ad.admitad.com/g/slsrdwx7led76c048b769027e976fc/?subid=hers&subid1=hers1");
        bundle1.putString("admitadid", "18070");
        bundle1.putString("raise", "INR 133");
        bundle1.putString("name", "Housejoy");
        bundle1.putString("imgurl", "https://gsered.com/charity/logo/Housejoy.jpg");
        swiggy = company_webview.newInstance();
        swiggy.setArguments(bundle1);

        Bundle bundle2 = new Bundle();
        bundle2.putString("url", "https://www.urbanclap.com/");
        ubereats = company_webview.newInstance();
        ubereats.setArguments(bundle2);

        Bundle bundle3 = new Bundle();
        bundle3.putString("url", "https://ad.admitad.com/g/k51xhlnn59d76c048b76af6443370e/?subid=hers&subid1=hers1");
        bundle3.putString("admitadid", "18803");
        bundle3.putString("raise", "18%");
        bundle3.putString("name", "Heimdal Security");
        bundle3.putString("imgurl", "https://gsered.com/charity/logo/Heimdalsecurity.png");
...
//        tabLayout.getTabAt(3).setCustomView(view4);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if(count==1)
            ...
            Intent i = new Intent(HomeServicesActivity.this, MainActivity.class);
            startActivity(i);
        }
