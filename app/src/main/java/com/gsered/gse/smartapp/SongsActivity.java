...
public class SongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://www.gsered.com/intern/grp10/GSE_App/images/songs/gaana.png").placeholder(R.mipmap.ic_launcher).into(imageView1);

        View view2 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView2 = (ImageView) view2.findViewById(R.id.icon);
        Glide.with(this).load("https://www.gsered.com/intern/grp10/GSE_App/images/songs/saavn.png").placeholder(R.mipmap.ic_launcher).into(imageView2);

        Bundle bundle1 = new Bundle();
        bundle1.putString("url", "https://gaana.com/");
        nearbuy = company_webview.newInstance();
        nearbuy.setArguments(bundle1);

        Bundle bundle2 = new Bundle();
        bundle2.putString("url", "https://www.jiosaavn.com/");
