...
public class EntertainmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://www.gsered.com/intern/grp10/GSE_App/images/entertainment/9gag.png").placeholder(R.mipmap.ic_launcher).into(imageView1);

        View view2 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView2 = (ImageView) view2.findViewById(R.id.icon);
        Glide.with(this).load("https://www.gsered.com/intern/grp10/GSE_App/images/entertainment/Flipboard.jpg").placeholder(R.mipmap.ic_launcher).into(imageView2);

        View view3 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
        imageView3 = (ImageView) view3.findViewById(R.id.icon);
        Glide.with(this).load("https://www.gsered.com/intern/grp10/GSE_App/images/entertainment/imdb.png").placeholder(R.mipmap.ic_launcher).into(imageView3);

//        View view4 = getLayoutInflater().inflate(R.layout.custom_tabicon, null);
//        imageView4 = (ImageView) view4.findViewById(R.id.icon);
//        Glide.with(this).load("https://www.gsered.com/intern/grp10/GSE_App/images/entertainment/9gag.png").placeholder(R.mipmap.ic_launcher).into(imageView4);

        Bundle bundle1 = new Bundle();
        bundle1.putString("url", "https://9gag.com/");
        swiggy = company_webview.newInstance();
        swiggy.setArguments(bundle1);

        Bundle bundle2 = new Bundle();
        bundle2.putString("url", "https://flipboard.com/");
        ubereats = company_webview.newInstance();
        ubereats.setArguments(bundle2);

        Bundle bundle3 = new Bundle();
        bundle3.putString("url", "https://www.imdb.com/");
